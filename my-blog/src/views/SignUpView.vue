    ...
    <div class="login-container">
        <div class="form login-form">
            ...
            <form class="py-3" @submit.prevent="onSubmitForm" >
                ...
                <div class="form-group">
                    <input type="password" class="form-control" placeholder="Mật khẩu" required v-model="data.password" @input="validate('password')">
                    <span v-if="passwordError" class="error">{{ passwordError }}</span>
                </div>
                <div class="form-group">
                    <input type="password" class="form-control" placeholder="Xác nhận mật khẩu" required v-model="data.rePassword" @input="validate('rePassword')">
